        ...
        <div className="main">
            <div className="up">
                <button className="card1">
                    <a href="https://www.instagram.com/asitsingh18/" target="blank">
                ...
                <button className="card2">
                    <a href="https://twitter.com/AsitSin37319666?s=09" target="blank">
            ...
            <div className="down">
                <button className="card3">
                    <a href="https://github.com/asitsi" target="blank">
                ...
                <button className="card4">
                    <a href="https://www.linkedin.com/in/asit-singh-b679b0156/" target="blank">
                        <svg viewBox="0 0 448 512" width="30px"  height="30px" xmlns="http://www.w3.org/2000/svg" className="discord" fill="white">
